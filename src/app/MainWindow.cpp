...
void MainWindow::buildInterface()
{
    ...
    auto *version = new QLabel(QStringLiteral("v0.1.41"), sidebar);
    ...
    connect(taskPage, &TaskPage::focusTaskRequested,
            this, [this, focusPage](int taskId) {
                focusPage->selectTask(taskId);
                navigation_->setCurrentRow(3);
            });
...
void MainWindow::applyTheme()
{
    setStyleSheet(QStringLiteral(R"(
        ...
        QLabel#mutedLabel, QLabel#focusTimeCaptionLabel,
        QLabel#focusElapsedLabel, QLabel#focusTotalDurationLabel {
            color: #667085;
            background: transparent;
        }
